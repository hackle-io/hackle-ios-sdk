...
class Reachability {
    ...
    required init(reachabilityRef: SCNetworkReachability) {
        ...
        self.reachabilitySerialQueue = DispatchQueue(label: "io.hackle.reachability")
        self.notificationQueue = .main
    }
    ...
    convenience init() throws {
        ...
        guard let reachabilityRef = SCNetworkReachabilityCreateWithAddress(nil, &zeroAddress) else {
