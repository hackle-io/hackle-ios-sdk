...
class HackleAbTestViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, OnOverrideSetListener, OnOverrideResetListener, HackleUserExplorerContainer {
    ...
    private func setupUI() {
        ...
        NSLayoutConstraint.activate([
            ...
            abTestTableView.leadingAnchor.constraint(equalTo: safeAreaAnchors.leading),
            abTestTableView.trailingAnchor.constraint(equalTo: safeAreaAnchors.trailing),
            abTestTableView.bottomAnchor.constraint(equalTo: safeAreaAnchors.bottom)
        ])
    }
