    ...
    override func spec() {
        ...
        describe("evaluateRemoteConfig") {
            ...
            it("type match") {
                ...
                try verifyMatch(HackleValue.number(0), HackleValue.string("default string"), false)
                try verifyMatch(HackleValue.number(1), HackleValue.string("default string"), false)
                ...
                try verifyMatch(HackleValue.number(0), HackleValue.number(999), true)
                try verifyMatch(HackleValue.number(1), HackleValue.number(999), true)
                try verifyMatch(HackleValue.number(-1), HackleValue.number(999), true)
                try verifyMatch(HackleValue.number(0.0), HackleValue.number(999), true)
                try verifyMatch(HackleValue.number(1.0), HackleValue.number(999), true)
                try verifyMatch(HackleValue.number(-1.0), HackleValue.number(999), true)
                try verifyMatch(HackleValue.number(1.1), HackleValue.number(999), true)
                try verifyMatch(HackleValue.string("1"), HackleValue.number(999), false)
                try verifyMatch(HackleValue.string("0"), HackleValue.number(999), false)
                try verifyMatch(HackleValue.bool(true), HackleValue.number(999), false)
                try verifyMatch(HackleValue.bool(false), HackleValue.number(999), false)
                ...
                try verifyMatch(HackleValue.number(0), HackleValue.bool(true), false)
                try verifyMatch(HackleValue.number(1), HackleValue.bool(false), false)
            }
